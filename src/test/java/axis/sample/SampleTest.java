...
import java.util.*;
import axis.model.Cat;
import axis.model.Person;
import axis.view.CatSimpleView;
import axis.repository.CatSimpleViewRepository;
...
public class SampleTest extends AbstractSampleTest {
    ...
    @EnableEntityViews(basePackages = { "axis.view"})
    @EnableJpaRepositories(
            basePackages = "axis.repository",
